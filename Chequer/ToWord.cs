...
namespace Chequer
{
    class ToWord
    {
        ...
        private static string[] arabicFeminineOnes =
           new string[] {
            String.Empty, "إحدى", "اثنتان", "ثلاث", "أربعة", "خمسة", "ستة", "سبعة", "ثمانة", "تسعة",
            "عشر", "إحدى عشرة", "اثنتا عشرة", "ثلاثة عشرة", "أربعة عشرة", "خمسة عشرة", "ستة عشرة", "سبعة عشرة", "ثمانية عشرة", "تسعة عشرة"
        };
        ...
        private static string[] arabicAppendedGroup =
            new string[] {
                     "", "الف", "مليون", "مليار", "تريليون", "كوادريليون", "كوينتليون", "سكستيليون"
        };
    ...
    {
        public enum Currencies { Sudan = 0, UAE, SaudiArabia, Dollar, Gold };
        ...
        public CurrencyInfo(Currencies currency)
        {
            switch (currency)
            {
                ...
                case Currencies.Dollar:
                    ...
                    Arabic2CurrencyName = "اثنان دولار";
